...
<html lang="en">
  ...
  <head>
    ...
    <title>Tramite Doc. | @yield('titulo')</title>
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Arturo Regalado Reyes</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    Arturo Regalado Reyes - Web Developer
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="/" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Tramite Doc.</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
            ...
            >
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a onclick="indexCategoria()" class="nav-link" href="#">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Categorias</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a onclick="indexNivelHigiene()" class="nav-link" href="#">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Niveles de Higiene</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a onclick="indexRangoPrecio()" class="nav-link" href="#">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Rango de Precios</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a onclick="indexOpcionNutritiva()" class="nav-link" href="#">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Opciones Nutritivas</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a onclick="indexRestaurante()" class="nav-link" href="#">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Restaurantes</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a onclick="indexImagenRestaurante()" class="nav-link" href="#">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Imagenes Restaurante</p>
                    </a>
                  </li>
                  <li class="nav-item">
              ...
              <li class="nav-header" style="display: none">EXAMPLES</li>
              <li class="nav-item" style="display: none">
                <a href="#" class="nav-link">
              ...
              <li class="nav-header" style="display: none">DOCUMENTATIONS</li>
              <li class="nav-item" style="display: none">
              ...
              <li class="nav-header" style="display: none">MULTI LEVEL EXAMPLE</li>
              <li class="nav-item" style="display: none">
                <a href="#" class="nav-link">
              ...
              <li class="nav-header" style="display: none">LABELS</li>
              <li class="nav-item" style="display: none">
                <a href="#" class="nav-link">
